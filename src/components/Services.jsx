 ...
 <div className="relative">
  <div className="relative z-1 flex flex-col lg:flex-row mb-5 p-8 border border-n-1/10 rounded-3xl overflow-hidden lg:p-20 xl:h-[46rem]">
    <div className="w-full md:w-3/6 lg:w-3/6 xl:w-auto mb-6 md:mb-0 md:relative md:ml-0">
      <img
        className="w-full h-full object-cover md:object-right border-n-1/10 rounded-3xl"
        width={800}
        height={730}
        alt="A Wadyclor"
        src={videogif}
    ...
    <div className="w-full lg:w-auto md:w-3/6 xl:max-w-[28rem] md:max-w-[21rem] ml-0 md:ml-auto md:pl-8">
      ...
      <p className="text-sm lg:text-sm md:text-xs mb-[1rem] text-n-2">
        Desenvolve as suas atividades de maneira responsável, em conformidade total com a legislação ambiental vigente e demais requisitos legais conforme exigido pelos órgãos de fiscalização e controle competentes, incluindo Polícias Civil e Federal, IBAMA, CETESB, Ministério da Defesa e Corpo de Bombeiros.
        <br /><br />
